...
namespace Scribble.Functions.Functions
{
    public static class LobbyFunctions
    {
            ...
            [DurableClient] IDurableOrchestrationClient starter)
        {
            ...
            if (string.IsNullOrEmpty(data.UserName) || data.UserName.Length < 5 || data.UserName.Length > 10 || data.UserName == "GAME_EVENT")
            ...
            [DurableClient] IDurableOrchestrationClient client)
        {
            ...
            if (string.IsNullOrWhiteSpace(data.UserName) || data.UserName.Length < 5 || string.IsNullOrWhiteSpace(data.GameCode) || data.UserName.Length > 10 || data.UserName == "GAME_EVENT")
                return new BadRequestResult();
